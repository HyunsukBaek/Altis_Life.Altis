class CarShops {
	...
	class civ_car {
		side = "civ";
		vehicles[] = {
				{ "B_Quadbike_01_F", 28000, { "" }, { "", "", -1 } },
				{ "C_Hatchback_01_F", 70000, { "driver" }, { "", "", -1 } },
				{ "C_Offroad_01_F", 80000, { "driver" }, { "", "", -1 } },
				{ "C_SUV_01_F", 90000, { "driver" }, { "", "", -1 } },
				{ "C_Hatchback_01_sport_F", 120000, { "driver" }, { "", "", -1 } },
				{ "C_Van_01_transport_F", 180000, { "driver" }, { "", "", -1 } }
		};
	};
	...
	class med_shop {
		...
		vehicles[] = {
				...
				{ "C_SUV_01_F", 55000, { "" }, { "", "", -1 } },
				{ "C_Hatchback_01_F", 74500, { "" }, { "", "", -1 } },
				{ "I_Truck_02_medical_F", 80000, { "" }, { "", "", -1 } },
				{ "O_Truck_03_medical_F", 85000, { "" }, { "", "", -1 } },
				{ "B_Truck_01_medical_F", 80000, { "" }, { "", "", -1 } }
		};
	};
	...
	class med_air_hs {
		side = "med";
		vehicles[] = {
				{ "B_Heli_Light_01_F", 265000, { "mAir" }, { "", "", -1 } },
				{ "O_Heli_Light_02_unarmed_F", 395000, { "mAir" }, { "", "", -1 } },
				{ "B_Heli_Transport_03_unarmed_F", 560000, { "mAir" }, { "", "", -1 } }
		};
	};
    ...
    class civ_truck {
        side = "civ";
        vehicles[] = {
            { "C_Van_01_box_F", 250000, { "trucking" }, { "", "", -1 } },
            { "I_Truck_02_transport_F", 505000, { "trucking" }, { "", "", -1 } },
            { "I_Truck_02_covered_F", 550000, { "trucking" }, { "", "", -1 } },
            { "B_Truck_01_transport_F", 775000, { "trucking" }, { "", "", -1 } },
//            { "O_Truck_03_transport_F", 200000, { "trucking" }, { "", "", -1 } },
//            { "O_Truck_03_covered_F", 250000, { "trucking" }, { "", "", -1 } },
//            { "B_Truck_01_box_F", 350000, { "trucking" }, { "", "", -1 } },
            { "C_Van_01_fuel_F", 190000, { "trucking" }, { "", "", -1 } }
        };
    };
	...
	class reb_car {
		side = "civ";
		vehicles[] = {
				{ "B_Quadbike_01_F", 35000, { "" }, { "", "", -1 } },
				{ "B_G_Offroad_01_F", 42500, { "" }, { "", "", -1 } },
				{ "O_MRAP_02_F", 560000, { "" }, { "", "", -1 } },
				{ "B_Heli_Light_01_F", 535000, { "" }, { "", "", -1 } },
				{ "O_Heli_Light_02_unarmed_F", 1050000, { "pilot" }, { "", "", -1 } },
				{ "I_Heli_Transport_02_F", 1350000, { "pilot" }, { "", "", -1 } },
	...
	class cop_car {
		...
		vehicles[] = {
				...
				{ "I_MRAP_03_hmg_F", 650000, { "" }, { "life_coplevel", "SCALAR", 3 } },
	...
	class civ_air {
		side = "civ";
		vehicles[] = {
				{ "B_Heli_Light_01_F", 563000, { "pilot" }, { "", "", -1 } },
				{ "O_Heli_Light_02_unarmed_F", 1050000, { "pilot" }, { "", "", -1 } }
		};
	};
	...
	class cop_air {
		...
		vehicles[] = {
				...
				{ "B_Heli_Attack_01_F", 200000, { "cAir" }, { "life_coplevel", "SCALAR", 2 } },
	...
	class civ_ship {
		...
		vehicles[] = {
				...
				{ "C_Boat_Civil_01_F", 45000, { "boat" }, { "", "", -1 } },
				{ "B_Boat_Transport_01_F", 125000, { "boat" }, { "", "", -1 } },
...
class LifeCfgVehicles {
	...
	class O_Truck_03_medical_F {
		vItemSpace = 200;
		storageFee[] = { 3000, 3000, 3000, 0 };
		garageSell[] = { 37000, 37000, 37000, 0 };
		insurance = 2500;
		chopShop = 22500;
		textures[] = {};
	};
	...
	class C_Rubberboat {
		vItemSpace = 145;
		storageFee[] = { 400, 400, 400, 0 };
		garageSell[] = { 15000, 15000, 15000, 0 };
		insurance = 2500;
		chopShop = 7500;
		textures[] = { };
	};
	...
	class B_Heli_Transport_01_F {
		vItemSpace = 200;
		storageFee[] = { 5000, 5000, 5000, 0 };
		garageSell[] = { 85000, 85000, 85000, 0 };
		insurance = 16000;
		chopShop = 45000;
		textures[] = {};
	};
	...
	class O_Heli_Attack_02_F {
		vItemSpace = 200;
		storageFee[] = { 5000, 5000, 5000, 0 };
		garageSell[] = { 2300000, 85000, 85000, 0 };
		insurance = 16000;
		chopShop = 1545000;
		textures[] = {};
	};
	class O_Heli_Attack_02_black_F {
		vItemSpace = 200;
		storageFee[] = { 5000, 5000, 5000, 0 };
		garageSell[] = { 850000, 85000, 85000, 0 };
		insurance = 16000;
		chopShop = 45000;
		textures[] = {};
	};
	...
	class I_MRAP_03_hmg_F {
		vItemSpace = 100;
		storageFee[] = { 1000, 1000, 1000, 1000 };
		garageSell[] = { 50000, 50000, 50000, 0 };
		insurance = 2500;
		chopShop = 100000;
		textures[] = {};
	};
	...
	class O_Boat_Armed_01_hmg_F {
		vItemSpace = 175;
		storageFee[] = { 1000, 1000, 1000, 0 };
		garageSell[] = { 21000, 21000, 21000, 0 };
		insurance = 2500;
		chopShop = 5000;
		textures[] = { };
	};
	...
	class O_Truck_03_transport_F {
		vItemSpace = 285;
		storageFee[] = { 1000, 1000, 1000, 0 };
		garageSell[] = { 100000, 100000, 100000, 0 };
		insurance = 2500;
		chopShop = 100000;
		textures[] = { };
	};
	...
	class B_G_Offroad_01_F {
		vItemSpace = 65;
		storageFee[] = { 1000, 1000, 1000, 0 };
		garageSell[] = { 18500, 18500, 18500, 0 };
		insurance = 2500;
		chopShop = 6250;
		textures[] = { };
	};
	...
	class B_G_Offroad_01_armed_F {
		vItemSpace = 65;
		storageFee[] = { 7500, 7500, 7500, 0 };
		garageSell[] = { 554000, 554000, 554000, 0 };
		insurance = 2500;
		chopShop = 450000;
		textures[] = { };
	};
	...
	class C_Boat_Civil_01_F {
		vItemSpace = 150;
		storageFee[] = { 4500, 4500, 0, 0 };
		garageSell[] = { 26800, 26800, 0, 0 };
		insurance = 2500;
		chopShop = 21000;
		textures[] = { };
	};
	...
	class B_Truck_01_Repair_F {
		vItemSpace = 60;
		storageFee[] = { 75000, 75000, 0, 0 };
		garageSell[] = { 75000, 75000, 0, 0 };
		insurance = 2500;
		chopShop = 75000;
		textures[] = { };
	};
	...
	class O_MRAP_02_hmg_F {
		vItemSpace = 60;
		storageFee[] = { 45000, 45000, 45000, 0 };
		garageSell[] = { 365000, 365000, 165000, 0 };
		insurance = 2500;
		chopShop = 235000;
		textures[] = {
				{ "Black", "cop", {"textures\rebel\blackmatte.jpg", "textures\rebel\blackmatte.jpg"} },
	...
	class O_Truck_02_medical_F {
		vItemSpace = 60;
		storageFee[] = { 45000, 45000, 45000, 0 };
		garageSell[] = { 175000, 175000, 175000, 0 };
		insurance = 2500;
		chopShop = 105000;
		textures[] = { };
	};
	...
	class O_MBT_02_cannon_F {
		vItemSpace = 60;
		storageFee[] = { 45000, 12000, 0, 0 };
		garageSell[] = { 650000, 650000 0, 0 };
		insurance = 2500;
		chopShop = 350000;
		textures[] = { };
	};
	...
	class B_Truck_01_ammo_F {
		vItemSpace = 60;
		storageFee[] = { 5000, 5000, 5000, 0 };
		garageSell[] = { 65000, 65000, 65000, 0 };
		insurance = 2500;
		chopShop = 1075000;
		textures[] = { };
	};
	...
	class C_Offroad_01_F {
		vItemSpace = 65;
		storageFee[] = { 1000, 1000, 1000, 1000 };
		garageSell[] = { 82500, 22500, 22500, 22500 };
		insurance = 2500;
		chopShop = 22250;
		textures[] = {
	...
	class C_Hatchback_01_sport_F {
		vItemSpace = 45;
		storageFee[] = { 2500, 2500, 2500, 2500 }; //차고저장가격
		garageSell[] = { 87000, 37000, 37000, 37000 };//되팔때가격
		insurance = 5500;
		chopShop = 25000;
		textures[] = {
	...
	class C_Hatchback_01_F {
		vItemSpace = 40;
		storageFee[] = { 1000, 1000, 1000, 0 };
		garageSell[] = { 17500, 17500, 17500, 0 };
		insurance = 2500;
		chopShop = 10750;
		textures[] = {
	...
	class C_SUV_01_F {
		vItemSpace = 70;
		storageFee[] = { 1400, 1400, 1400, 0 };
		garageSell[] = { 32500, 32500, 32500, 0 };
		insurance = 2500;
		chopShop = 25000;
		textures[] = {
	...
	class C_Van_01_transport_F {
		vItemSpace = 110;
		storageFee[] = { 3000, 3000, 3000, 0 };
		garageSell[] = { 142000, 42000, 42000, 0 };
		insurance = 2500;
		chopShop = 30500;
		textures[] = {
				{ "White", "civ", {
	...
	class B_Heli_Light_01_F {
		vItemSpace = 190;
		storageFee[] = { 25000, 5000, 5000, 0 };
		garageSell[] = { 351000, 251000, 251000, 0 };
		insurance = 2500;
		chopShop = 150000;
		textures[] = {
	...
	class O_Heli_Light_02_unarmed_F {
		vItemSpace = 250;
		storageFee[] = { 55000, 10000, 12000, 0 };
	...
	class B_Heli_Transport_03_unarmed_F {
		vItemSpace = 350;
		storageFee[] = { 12000, 12000, 12000, 0 };
		garageSell[] = { 355000, 355000, 355000, 0 };
		insurance = 2500;
		chopShop = 355000;
		textures[] = {
				{ "Black", "cop", {
