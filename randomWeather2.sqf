...
mb_fnc_InitialWeather = {
    ...
    _weatherInitialRainSnow = _weatherInitialSettings select 0;
    _weatherInitialFog = _weatherInitialSettings select 0;
    _weatherInitialWindEW = _weatherInitialSettings select 0;
    _weatherInitialWindNS = _weatherInitialSettings select 0;	
